...
/**
 * A class to display an instructions button on screen
 * 
 * @author Shivani Chidella 
 * @version Jan 2017
 */
public class InsButton extends Actor
{
    ...
    public void act() 
    {
        // Conditional to take the user to the instructions page.
     ...
     */
    public InsButton(int value, int fontSize)
    {
     ...
     */
    public InsButton(String value, int fontSize)
    {
        this.value = value;
